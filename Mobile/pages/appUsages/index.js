...
export default function AppUsages({navigation, route}){
    let pages = [
        ...
        <Tab.Screen name="Usuarios" component={Usuarios} options={{headerShown:false}} options={{tabBarIcon: ({ color }) => (<MaterialCommunityIcons name="account-cog" color={color} size={26} />),}}></Tab.Screen>
    ]
    return(
